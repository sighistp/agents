...
from blueprint.utils.logger import get_logger, setup_logging
...
def test_get_logger():
    """get_logger should return a logger under the blueprint namespace."""
    logger = get_logger("pm")
    assert isinstance(logger, logging.Logger)
    assert logger.name == "blueprint.pm"
