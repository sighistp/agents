...
from blueprint.agents.state import ProjectState, create_initial_state
...
def test_pm_system_prompt_exists():
    ...
    from blueprint.agents.pm import PM_SYSTEM_PROMPT
...
def test_pm_critic_prompt_exists():
    ...
    from blueprint.agents.pm import PM_CRITIC_PROMPT
...
def test_build_pm_prompt_basic():
    ...
    from blueprint.agents.pm import build_pm_prompt
...
def test_build_pm_prompt_includes_system_prompt():
    ...
    from blueprint.agents.pm import PM_SYSTEM_PROMPT, build_pm_prompt
...
@pytest.mark.asyncio
@patch("blueprint.agents.pm.call_llm_async")
...
def test_pm_agent_import():
    """pm_agent should be importable from blueprint.agents.pm."""
    from blueprint.agents.pm import pm_agent as imported_pm_agent
