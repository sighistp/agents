"""SQLite-backed user database for Blueprint.
...
from blueprint.api.auth import hash_password, verify_password
        ...
        with _db_lock:
            if _user_db is None:
                db_path = os.environ.get(
                    "BLUEPRINT_AUTH_DB",
                    os.path.join(os.path.dirname(__file__), "..", "BLUEPRINT_users.db"),
                )
