"""Blueprint — AI 全栈开发平台启动脚本

一键启动 Blueprint 服务，浏览器自动打开。
"""
...
from blueprint.utils.logger import setup_logging
...
async def root():
    ...
    return {"message": "Blueprint API is running. Static files not found."}
