...
def test_architect_system_prompt_exists():
    ...
    from devteam.agents.architect import ARCHITECT_SYSTEM_PROMPT
...
def test_architect_critic_prompt_exists():
    ...
    from devteam.agents.architect import ARCHITECT_CRITIC_PROMPT
...
def test_build_architect_prompt_basic():
    ...
    from devteam.agents.architect import build_architect_prompt
    state = {
...
def test_build_architect_prompt_includes_system_prompt():
    ...
    from devteam.agents.architect import build_architect_prompt, ARCHITECT_SYSTEM_PROMPT
    state = {
        "user_stories": [{"id": "US-001", "title": "Create todo"}],
        "features": [],
        "requirement": "Build a todo app",
...
async def test_architect_agent_returns_correct_keys():
    ...
    with patch("devteam.agents.architect.call_llm_async", return_value=mock_response.content):
        state = {
            "user_stories": [{"id": "US-001", "title": "Create todo"}],
            "features": [],
            "requirement": "Build a todo app",
...
async def test_architect_agent_sets_current_agent_to_developer():
    ...
    with patch("devteam.agents.architect.call_llm_async", return_value=mock_response):
        state = {
            "user_stories": [{"id": "US-001", "title": "Create todo"}],
            "features": [],
            "requirement": "Build a todo app",
...
async def test_architect_agent_calls_llm():
    ...
    with patch("devteam.agents.architect.call_llm_async", return_value=mock_response) as mock_llm:
        state = {
            "user_stories": [{"id": "US-001", "title": "Create todo"}],
            "features": [],
            "requirement": "Build a todo app",
...
async def test_architect_agent_handles_invalid_json():
    ...
    with patch("devteam.agents.architect.call_llm_async", return_value="not valid json"):
        state = {
            "user_stories": [{"id": "US-001", "title": "Create todo"}],
            "features": [],
            "requirement": "Build a todo app",
...
async def test_architect_agent_handles_llm_exception():
    ...
    with patch("devteam.agents.architect.call_llm_async", side_effect=Exception("API Error")):
        state = {
            "user_stories": [{"id": "US-001", "title": "Create todo"}],
            "features": [],
            "requirement": "Build a todo app",
