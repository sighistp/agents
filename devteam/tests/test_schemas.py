...
def test_pm_output_valid():
    ...
    from devteam.agents.schemas import PMOutput, UserStory, Feature
...
def test_pm_output_with_clarification():
    ...
    from devteam.agents.schemas import PMOutput, UserStory
...
def test_architect_output_valid():
    ...
    from devteam.agents.schemas import ArchitectOutput, APIEndpoint, DataModel
...
def test_developer_output_valid():
    ...
    from devteam.agents.schemas import DeveloperOutput, CodeFile
...
def test_tester_output_valid():
    ...
    from devteam.agents.schemas import TesterOutput, TestCase, TestResult
...
def test_reviewer_output_valid():
    ...
    from devteam.agents.schemas import ReviewerOutput, ReviewIssue
