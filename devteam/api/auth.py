"""JWT authentication and password hashing for DevTeam.
...
_SECRET_FILE = Path(__file__).parent.parent / ".devteam_secret"
...
def _get_jwt_secret() -> str:
    ...
    if _JWT_SECRET is None:
        _JWT_SECRET = os.environ.get("DEVTEAM_JWT_SECRET", "")
        if not _JWT_SECRET:
...
def _get_user_db():
    ...
    from devteam.api.user_db import get_user_db
    return get_user_db()
