...
.score-green .score-num { color: var(--success); }
.score-yellow .score-num { color: #eab308; }
.score-red .score-num { color: var(--error); }
.grade-badge { font-size: 24px; font-weight: 700; padding: 8px 16px; border-radius: 8px; }
.score-green .grade-badge { background: rgba(34,197,94,0.15); color: var(--success); }
.score-yellow .grade-badge { background: rgba(234,179,8,0.15); color: #eab308; }
.score-red .grade-badge { background: rgba(239,68,68,0.15); color: var(--error); }
...
.dim-green { background: var(--success); }
.dim-yellow { background: var(--warning); }
.dim-red { background: var(--error); }
